...
namespace SuperTiled2Unity.Editor
{
    public class SuperObjectLayerLoader : SuperLayerLoader
    {
        ...
        private void CreateObject(XElement xObject)
        {
            ...
            Importer.AddSuperCustomProperties(superObject.gameObject, xObject, xObject.Element("properties"), superObject.m_SuperTile, superObject.m_Type);
        ...
        private SuperObject CreateSuperObject(XElement xObject)
        {
            ...
            var puzzleParent = xObject.GetAttributeAs("PuzzleParent", "");
        ...
        private void ProcessTileObject(SuperObject superObject, XElement xObject)
        {
            ...
            goCF.transform.localPosition = Vector2.zero;
            ...
            goTile.transform.localPosition = Vector2.zero;
            ...
            // Add the renderer
            //var superCustomProperties = superObject.GetComponent<SuperCustomProperties>();
            //if (superCustomProperties == null)
            //    objRenderer.SetAsProps();
            //else
            //{
            //    superCustomProperties.TryGetCustomProperty("GroundProps", out CustomProperty groundPropsProperty);
            //    if (groundPropsProperty != null)
            //        objRenderer.SetAsGroundProps();
            //}
