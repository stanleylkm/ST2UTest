...
namespace SuperTiled2Unity.Editor
{
    ...
    public partial class TmxAssetImporter : TiledAssetImporter
    {
        ...
        protected override void InternalOnImportAsset()
        {
            ...
            FindObjectsOfType<SuperMap>().ToList().ForEach(x => x.SetLayersPriority());
        ...
        private void ProcessMap(XElement xMap)
        {
            ...
            {
                PuzzleParents.Clear();
                PlaceholderPuzzleParents.Clear();
        ...
        private void DoPrefabReplacements()
        {
            ...
            foreach (var so in supers)
            {
                ...
                if (prefab != null)
                {
                    ...
                    instance.transform.position = so.transform.position;
                    ...
                    if (props != null)
                    {
                        ...
                        {
                            //Debug.Log(p.m_Name);
                            instance.gameObject.BroadcastProperty(so, p);
                        }
                    }

                    //if (instance.GetComponent<BasePickup>() != null)
                    //    instance.GetComponent<BasePickup>().SetPickUpId(so.m_Id);
