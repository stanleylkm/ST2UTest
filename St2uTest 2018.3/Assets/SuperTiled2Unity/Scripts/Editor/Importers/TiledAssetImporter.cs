...
#pragma warning restore 414
        ...
        public static List<Transform> PuzzleParents = new List<Transform>();
        //temp parent, children
        public static Dictionary<Transform, List<Transform>> PlaceholderPuzzleParents = new Dictionary<Transform, List<Transform>>();
        ...
        {
            AddSuperCustomProperties(go, null, xProperties, null, typeName);
        }

        public void AddSuperCustomProperties(GameObject go, XElement xObject, XElement xProperties, SuperTile tile, string typeName)
        {
        ...
        protected void AssignUnityTag(SuperCustomProperties properties)
        {
            ...
            else
            {
                ...
                {
                    layerName = prop.m_Value;
                    properties.gameObject.tag = layerName;
                }
            }
        }
