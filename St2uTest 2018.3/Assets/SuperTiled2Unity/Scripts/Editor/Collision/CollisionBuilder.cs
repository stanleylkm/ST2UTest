        ...
        public void Build(SuperImporter importer)
        {
            ...
            foreach (var pair in m_CollisionClippers)
            {
                ...
                if (clipper.ClosedPaths.Any() || clipper.OpenPaths.Any())
                {
                    ...
                    //SuperCustomProperties parentSuperProperties = goCollider.GetComponentInParent<SuperCustomProperties>();
                    //if (parentSuperProperties)
                    //{
                    //    CustomProperty prop;
                    //    if (parentSuperProperties.TryGetCustomProperty("unity:water", out prop))
                    //        goCollider.AddComponent<WaterLayer>();
                    //    else
                    //    {
                    //        if (parentSuperProperties.TryGetCustomProperty("unity:layer", out prop))
                    //        {
                    //            if (prop.m_Value.Contains("Ground"))
                    //                goCollider.AddComponent<PathLayer>();
                    //            else if (prop.m_Value.Contains("Object"))
                    //                goCollider.AddComponent<StaticColliderLayer>();
                    //        }
                    //    }
                    //}
