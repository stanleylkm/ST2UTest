    ...
    public class SuperTile : TileBase
    {
        ...
        public override bool GetTileAnimationData(Vector3Int position, ITilemap tilemap, ref TileAnimationData tileAnimationData)
        {
            if (m_AnimationSprites != null && m_AnimationSprites.Length > 1)
            {
                ...
                {
                    var randomstartPropIndex = m_CustomProperties.FindIndex(x => x.m_Name == "randomstart");
                    //var randomintervalPropIndex = m_CustomProperties.FindIndex(x => x.m_Name == "randominterval");

                    //if (randomstartPropIndex >= 0)
                    //    startTime = UnityEngine.Random.Range(0, m_CustomProperties[randomstartPropIndex].GetValueAsFloat());

                    //if (randomintervalPropIndex >= 0)
                    //    startTime = m_CustomProperties[randomintervalPropIndex].GetValueAsFloat();

                    //m_CustomProperties.Find(x => x.m_Name == "randomstart").GetValueAsFloat();
                }
